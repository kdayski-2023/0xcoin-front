              ...
              <div className="col-lg-5 col-md-10">
                <div className="login-content">
                  ...
                  <div className="form-grp">
                    ...
                    <div className="form-grp checkbox-grp" style={{display: 'flex', alignItems: 'center'}}>
                        <input
                          type="checkbox"
                        ...
                        />
                        <label htmlFor="isLicenseAccepted">Accept the license agreement</label>
                    ...
                    <div className='link-btn__custom' onClick={() => navigate('/login')}>Log in</div>
                    </span>
                  </form>
                </div>
              </div>
